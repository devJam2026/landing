...
export default function About() {
  ...
  return (
    <section id="about" className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-12 py-8 md:py-12 scroll-mt-20 border-t border-card-border">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
          {points.map((point, index) => {
            ...
            return (
              <div
                key={index}
                className="flex flex-col gap-3 rounded-xl border border-card-border bg-card-bg p-5 hover:border-violet-500/20 transition-all duration-300"
              >
                <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-violet-500/10 text-violet-600 dark:text-violet-400 border border-violet-500/10 dark:border-violet-500/20 shadow-inner">
