      ...
      <main className="relative flex flex-col pt-20">
        ...
        <section className="mx-auto max-w-5xl px-4 sm:px-6 py-6 md:py-10 w-full flex flex-col gap-10">
          ...
          <PageHero
            ...
            description="A project-based engineering progression taking you from capacity estimations and database sharding to message queues, distributed locks, and real-world case studies."
          />
          ...
          <div className="premium-card rounded-2xl p-6 md:p-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 overflow-x-auto pb-4">
              ...
              {/* Row 1 */}
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 min-w-[950px] bg-[#030712] p-6 rounded-xl border border-card-border/60 font-mono text-[9px] font-bold text-text-muted uppercase text-center">
              ...
              {/* Row 2 */}
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 min-w-[950px] bg-[#030712] p-6 rounded-xl border border-card-border/60 font-mono text-[9px] font-bold text-text-muted uppercase text-center mt-2">
              ...
              {/* Row 4 */}
              <div className="flex flex-col md:flex-row items-center justify-start gap-4 min-w-[950px] bg-[#030712] p-6 rounded-xl border border-card-border/60 font-mono text-[9px] font-bold text-text-muted uppercase text-center mt-2">
