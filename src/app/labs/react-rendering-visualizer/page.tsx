...
export default function ReactRenderingVisualizerLabPage() {
  const techs = ["React 19", "TypeScript", "Framer Motion", "Tailwind CSS", "Vercel", "GitHub"];
  const concepts = [
  ...
  const interviewQuote = "I built this renderer visualizer to dissect component tree updates and fiber node states. Clicking triggers updates cell counts, which computes virtual DOM diffs and flashes target elements. This helped me gain concrete intuition on reconciliation, Batching states, and selecting key values properly in lists.";
      ...
      <main className="relative flex flex-col pt-20">
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 py-6 md:py-10 w-full flex flex-col gap-6">
          <ProjectHero
            ...
            description="Deconstruct virtual DOM diffing. Trigger renders, inspect cell status propagation, and visualize tree updates inside component trees."
            github="https://github.com/devJam2026/landing"
            live="/labs/react-rendering-visualizer"
            status="Active"
            outcome="Master React reconciliation, fiber lifecycle stages, memoization optimizations, and component rendering triggers."
            isCyan={true}
          />
          ...
          <div className="border border-card-border/60 bg-[#060a13]/80 rounded-2xl p-6 shadow-2xl mb-4">
            ...
            <InteractiveLabs singleLab="react" />
          </div>

          <div className="rounded-xl border border-card-border/60 bg-[#060a13]/40 p-6 md:p-8 flex flex-col gap-6 shadow-xl">
            {/* 1. Problem */}
            <ProjectSection kicker="01. Problem it solves" title="Inefficient Render Cascades" isCyan={true}>
              <p>
            ...
            {/* 2. Concept */}
            <ProjectSection kicker="02. Concept it teaches" title="Component Life & Diffing Rules" isCyan={true}>
              <p className="mb-4">
            ...
            {/* 3. What I built */}
            <ProjectSection kicker="03. What I built" title="Fiber Diffing Workspace" isCyan={true}>
              <p className="mb-4">
              ...
              <div className="flex flex-col gap-3 text-xs font-mono">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link
                    ...
                    className="text-foreground hover:text-cyan-400 hover:underline transition-all"
                  >
                    /labs/react-rendering-visualizer
                  </Link>
                </div>
              </div>
            </ProjectSection>
